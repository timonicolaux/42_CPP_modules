...
/*   Updated: 2024/07/17 08:52:25 by tnicolau         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << "Copy constructor called, " << name << " created" << std::endl;
	*this = copy;
	return ;
}
...
ClapTrap::~ClapTrap()
{
	std::cout << "Default destructor called, " << name << " destroyed" << std::endl;
	return ;
}
